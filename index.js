function mixedMessages(){
        ...
        let firstArrayMessages=[ //first arry of messages
        ...
        let secondArrayMessages=[ //second array of messages
        ...
        let thirdArrayMessages=[ //third array of messages
        ...
        return `${firstMessage}| ${secondMessage}| ${thirdMessage} ` ;  //return  3 differents messages separeted by |  
    }
